...
def display_matches(I1, pts1, I2, pts2):
	...
	for p1, p2 in zip(pts1, pts2):
		...
		plt.plot(x1, y1, 'bo', markersize=3, color=random_color)
		plt.plot(x2 + w, y2, 'bo', markersize=3, color=random_color)
		
		plt.plot([x1, x2 + w], [y1, y2], color=random_color, linewidth=0.8)
